  ...
  "task_create",
  {
    ...
    inputSchema: {
      ...
      type: z
        ...
        .optional()
        .default("AGENT")
        .describe("Task type (defaults to AGENT)"),
      assignedTo: z
        .object({
          personId: z.string(),
          name: z.string(),
        ...
        .optional()
        .describe("Person to assign to ({ personId, name })"),
...
server.registerTool(
  "task_update",
  {
    ...
    inputSchema: {
      ...
      state: z
        .enum(["TODO", "IN_PROGRESS", "BLOCKED", "DONE", "CANCELLED", "ARCHIVED"])
        .optional()
        .describe("Task state transition"),
      description: z.string().optional().describe("Updated description"),
      priority: z.number().min(0).max(10).optional().describe("Priority (0-10)"),
      assignedTo: z
        .object({
          personId: z.string(),
          name: z.string(),
        ...
        .nullable()
        .optional()
        .describe("Person to assign to, or null to unassign"),
