...
- **Optional wildcard cell — DROPPED at Task-0 (2026-08-19)**: Deepgram Flux TTS (GA 2026-08-12) has no agents-js plugin support at 1.6.4 (TTSModels = aura/aura-2 only; the claimed 1.6.9 support does not exist — 1.6.9 was never published). Delivery-discretion clause exercised: wildcard cell dropped; revisit if a plugin release lands before the PoC window.
