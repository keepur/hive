...
Two provisions beyond this spec's minimum were added during the review loop and are recorded here for the public mirror's completeness (full decision detail is in the KPR-380 Decision Register — Canon, on the epic ticket):
