...
**Interfaces, compatibility, and invariants:** Standing Invariants 1–4. L2 scoring specifically: do **not** copy KPR-464's frozen "no optional opening" cell (spec §4.2, canon R6) — classify strictly from the ordering table below.
