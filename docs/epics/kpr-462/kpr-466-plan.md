...
**Readiness:** DRAFT — revision round 6, addressing round-5 review findings; not yet approved. Nothing in this plan assumes KPR-463 T9 has passed, that a KPR-465 configuration decision exists, or that May's go has been given. Task 1 is the only task this plan authorizes to run before those exist.
